...
/// (D-078, P-3). <c>display_name</c> joins with the naming-fidelity slice.
/// </summary>
...
/// <param name="Template">Referenced <c>[[template]]</c> id (§9.1); carried, but a reference fails resolve until M6 (D-078).</param>
